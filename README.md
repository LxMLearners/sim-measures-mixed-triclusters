...
* `Experiments.ipynb`: The main notebook containing the 9 sanity check scenarios, feature heterogeneity sensitivity tests, structural overlap tests, and runtime profiling.
* `visualize_patterns.py`: Helper functions for virtual pattern representation.

## How to Run
1. Clone this repository:
   ```bash
   git clone [https://github.com/](https://github.com/)[teu-username]/[nome-do-repo].git
